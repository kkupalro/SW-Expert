	...
	public static void main(String[] args) throws IOException {
		...
		else if(N % 2 == 0) // 짝수
		{
			...
			else if(N % 4 != 0)
			{
				...
				y = r; x = c/2;
				while(data++ < (int)Math.pow((2 * n) + 1, 2))
				{
					ny = (y==0)?c-1:y-1;
					nx = (x==c-1)?0:x+1;
					if(matrix[ny][nx] == 0)
				...
				y = r; x = c + n;
				// (n ~ 2n)
				while(data++ < (int)Math.pow((2 * n) + 1, 2) * 2)
				{
					ny = (y==c)?N-1:y-1;
					nx = (x==N-1)?c:x+1;
					if(matrix[ny][nx] == 0)
				...
				y = r; x = c + n;
				// (n ~ 2n)
				while(data++ < (int)Math.pow((2 * n) + 1, 2) * 3)
				{
					ny = (y==0)?c-1:y-1;
					nx = (x==N-1)?c:x+1;
					if(matrix[ny][nx] == 0)
				...
				y = r; x = c/2;
				// (n ~ 2n)
				while(data++ < (int)Math.pow((2 * n) + 1, 2) * 4)
				{
					ny = (y==c)?N-1:y-1;
					nx = (x==c-1)?0:x+1;
					if(matrix[ny][nx] == 0)
